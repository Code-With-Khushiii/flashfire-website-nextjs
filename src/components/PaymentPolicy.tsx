      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Payment Policy</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-6">
              All payments are processed in US Dollars (USD). International customers may be subject to currency conversion fees imposed by their financial institution.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Pricing Structure</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Service Plans</h3>
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              <ul className="text-gray-700 space-y-2">
                <li><strong>Ignite Plan:</strong> $249 (originally $349) - 250 applications</li>
                <li><strong>Professional Plan:</strong> $399 (originally $499) - 500 applications</li>
                <li><strong>Executive Plan:</strong> $649 (originally $749) - 1000 applications</li>
              </ul>
            </div>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">Free Trial Terms</h3>
            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 mb-6">
              <p className="text-gray-700">
                <strong>Trial Obligation:</strong> If you receive any interview call or recruiter response during the free trial period, you agree to pay a one-time service fee of $50 per interview call within 7 business days.
              </p>
            </div>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Payment Processing</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3">When Payments Are Charged</h3>
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              <li>Immediately upon plan selection and confirmation</li>
              <li>At the beginning of each billing cycle for recurring subscriptions</li>
              <li>Within 7 days of confirmed interview calls during trial period</li>
              <li>Upon purchase of additional services or upgrades</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">Payment Confirmation</h3>
            <p className="text-gray-700 mb-6">
              You will receive an email confirmation for all successful payments, including transaction details, service description, and receipt information. Please retain these confirmations for your records.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Billing and Invoicing</h2>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Invoice Details</h3>
            <p className="text-gray-700 mb-6">
              All invoices include service description, billing period, amount due, payment due date, and applicable taxes. Invoices are sent via email to your registered email address.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Failed Payments</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Payment Failure Process</h3>
            <ol className="list-decimal list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>Service termination after 14 days without payment resolution</li>
            </ol>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">Resolving Payment Issues</h3>
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Taxes and Fees</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Sales Tax</h3>
            <p className="text-gray-700 mb-6">
              Sales tax may be applied based on your billing address and local tax regulations. Tax amounts will be clearly displayed before payment confirmation.
            </p>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>Payment information is processed by certified payment processors</li>
            ...
            <p className="text-gray-700 mb-6">
              Our payment processing partners are PCI DSS compliant, ensuring the highest standards of payment card data security.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Before initiating a chargeback with your bank, please contact our support team to resolve any payment disputes. We are committed to finding fair solutions quickly.
            </p>
            ...
            <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
              ...
              <li>We will provide documentation to support legitimate charges</li>
              <li>Chargeback fees may be passed on to the customer if the dispute is resolved in our favor</li>
            </ul>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-700"><strong>Subject Line:</strong> "Payment Inquiry - [Your Name]"</p>
              <p className="text-gray-700"><strong>Phone:</strong> Available upon request for urgent payment issues</p>
              <p className="text-gray-700"><strong>Response Time:</strong> Within 24 hours during business days</p>
            </div>

            <div className="mt-8 p-6 bg-purple-50 rounded-lg border border-purple-200">
              <p className="text-purple-800 font-medium">
                We are committed to transparent and secure payment processing. If you have any questions about our payment policies or need assistance with billing, our support team is here to help.
              </p>
            </div>
          </div>
        </div>
